...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void register() {
    ...
    if (name.length <= 3) {
      _showSnackBar('O nome deve ter mais de 3 caracteres.', Colors.redAccent);
      return;
    }

    if (phone.length < 11) {
      _showSnackBar('Digite o telefone completo com DDD.', Colors.redAccent);
      return;
    }

    final emailRegex = RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$');
    if (!emailRegex.hasMatch(email)) {
      _showSnackBar('Digite um e-mail válido.', Colors.redAccent);
      return;
    }
    ...
    debugPrint('Telefone (Sem máscara): $phone');
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(child: FitnessaLogo(iconSize: 45, textSize: 23)),
